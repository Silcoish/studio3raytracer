...
namespace kf
{
   ...
   public:
	  ...
	  inline Vector3T reflect(const Vector3T &n)
	  {
      ...
      inline Vector3T &operator,(T c)
      {
		...
		inline Vector3T x0z()
		{
			return Vector3T(x,0,z);
		}

inline Vector3T<T> xxx() const
{
	return Vector3T<T>(x, x, x);
}

inline Vector3T<T> xxy() const
{
	return Vector3T<T>(x, x, y);
}

inline Vector3T<T> xxz() const
{
	return Vector3T<T>(x, x, z);
}

inline Vector3T<T> xyx() const
{
	return Vector3T<T>(x, y, x);
}

inline Vector3T<T> xyy() const
{
...
inline Vector3T<T> xzx() const
{
	return Vector3T<T>(x, z, x);
}

inline Vector3T<T> xzy() const
{
	return Vector3T<T>(x, z, y);
}

inline Vector3T<T> xzz() const
{
	return Vector3T<T>(x, z, z);
}

inline Vector3T<T> yxx() const
{
	return Vector3T<T>(y, x, x);
}

inline Vector3T<T> yxy() const
{
	return Vector3T<T>(y, x, y);
}

inline Vector3T<T> yxz() const
{
	return Vector3T<T>(y, x, z);
}

inline Vector3T<T> yyx() const
{
	return Vector3T<T>(y, y, x);
}

inline Vector3T<T> yyy() const
{
	return Vector3T<T>(y, y, y);
}

inline Vector3T<T> yyz() const
{
...
inline Vector3T<T> yzy() const
{
	return Vector3T<T>(y, z, y);
}

inline Vector3T<T> yzz() const
{
	return Vector3T<T>(y, z, z);
}

inline Vector3T<T> zxx() const
{
...
inline Vector3T<T> zyy() const
{
	return Vector3T<T>(z, y, y);
}

inline Vector3T<T> zyz() const
{
	return Vector3T<T>(z, y, z);
}

inline Vector3T<T> zzx() const
{
	return Vector3T<T>(z, z, x);
}

inline Vector3T<T> zzy() const
{
	return Vector3T<T>(z, z, y);
}

inline Vector3T<T> zzz() const
{
